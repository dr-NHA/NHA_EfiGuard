...
//
#define EFIGUARD_BACKDOOR_VARIABLE_NAME L"OEM_NHA_EFI" // "EfiGuardBackdoor" // TODO: randomize?
...
//
typedef EFI_STATUS (EFIAPI* EFIGUARD_CONFIGURE)(IN CONST EFIGUARD_CONFIGURATION_DATA* ConfigurationData);
